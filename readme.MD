...
1 - Não deve aplicar cupom de desconto expirado - Feito, preciso validar se a condicional é chamada dentro do useCase, ou da entidade... acredito que seja dentro da entidade por isso estar com uma cara de regra de negocio
2 - Ao fazer um pedido, a quantidade de um item não pode ser negativa - feito
